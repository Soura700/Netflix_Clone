...
//         <BiChevronLeft
//           className="absolute top-0 bottom-0 left-2 z-40 m-auto h-9 w-9 cursor-pointer text-gray-400 transition hover:scale-125 group-hover:opacity-100"
...
//         <BiChevronRight
//           className="absolute top-0 bottom-0 right-2 z-40 m-auto h-9 w-9 cursor-pointer text-gray-400 transition hover:scale-125 group-hover:opacity-100"
  ...
  return (
    ...
    >
      ...
      >
        ...
        <BiChevronRight
          className="absolute top-0 bottom-0 right-2 z-40 m-auto h-9 w-9 cursor-pointer text-gray-400 group-hover:opacity-100"
          onClick={() => handleClick("right")}
        />
      </div>
    </div>
